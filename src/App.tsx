...
function App() {
  ...
  return (
    <div
      className={`${isDark ? 'dark' : ''} min-h-screen bg-amber-50/40 dark:bg-slate-950 text-stone-900 dark:text-slate-100`}
    >
      <header className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-slate-900 dark:via-indigo-950 dark:to-slate-950 border-b border-amber-200 dark:border-slate-800">
        <div className="mx-auto max-w-6xl px-6 py-8">
          <div className="flex items-center gap-3">
            <Home className="h-8 w-8 text-orange-600 dark:text-sky-400" aria-hidden="true" />
